...
// Ocitava tastaturu (LASTK) tokom zadatog vremena
...
main(){
	...
	printf("%c%cDobrodosli u kviz o poznavanju jednog o najpopularnijih 8-bitnih racunara 80-tih godina, 'ZX Spectrum'-a. ",1,64);
	printf("Kroz %d pitanja bice provereno Vase znanje o pojedinostima o njegovom nastanku i funkcionisanju. ", BR_KVPIT);
	printf("Za svako pitanje je ponudjeno %d odgovora, koje birate pritiskom na tastere '1'-'%d'. ", BR_ODG, BR_ODG);
	printf("Vreme za odgovor na svako pojedinacno pitanje je %d sekundi. ", VREME_PIT);
